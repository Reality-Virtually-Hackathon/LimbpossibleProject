...
namespace VRTK
{
...
#endif
    {
        ...
        public override Transform GetHeadset()
        {
            ...
            {
                GameObject scratch = VRTK_SharedMethods.FindEvenInactiveGameObject<OVRCameraRig>("TrackingSpace/CenterEyeAnchor");
                cachedHeadset = scratch != null ? scratch.transform : null;
            }
