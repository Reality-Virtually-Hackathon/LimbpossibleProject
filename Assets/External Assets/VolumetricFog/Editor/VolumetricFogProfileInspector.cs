...
namespace VolumetricFogAndMist {
				...
				public class VolumetricFogProfileInspector : Editor {
								...
								static GUIStyle blackStyle;
								static GUIStyle disabledStyle;
								Color titleColor;
								...
								SerializedProperty noiseScale, noiseSparse, alpha, color, specularColor, specularThreshold, specularIntensity, lightDirection, lightIntensity, lightColor;
								SerializedProperty speed, windDirection;
								SerializedProperty turbulenceStrength, useXYPlane;
								SerializedProperty skyColor, skyHaze, skySpeed, skyNoiseStrength, skyAlpha;
								SerializedProperty stepping, steppingNear, dithering, ditherStrength;
