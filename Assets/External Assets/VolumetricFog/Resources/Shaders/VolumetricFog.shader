...
//		_VolumetricFogSunWorldPos("Sun World Position", Vector) = (0,0,0, 1000)
//		_VolumetricFogSunShadowsData("Sun Shadows Params", Vector) = (0.5, 0.05, 0)
//		_VolumetricFogSunDepthTexture ("Sun Shadows Tex", 2D) = "white" {}
...
#pragma multi_compile __ FOG_TRANSPARENCY_BLEND_PASS
