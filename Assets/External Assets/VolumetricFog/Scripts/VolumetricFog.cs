    ...
    public enum FOG_AREA_FOLLOW_MODE
    {
        ...
        RestrictToXZPlane = 1
				...
				public partial class VolumetricFog : MonoBehaviour {
								...
								const string VFM_BUILD_HINT = "VFMBuildHint80";
        ...
        [SerializeField]
                    ...
                    if (mainCamera == null) mainCamera = fogRenderer.GetComponent<Camera>();
																}
												}
...
//																								needUpdateTexture = true;
                ...
                if (_fogAreaFollowMode == FOG_AREA_FOLLOW_MODE.FullXYZ)
                {
                    ...
                    _fogAreaPosition.z = _fogAreaCenter.transform.position.z;
								...
								internal void DoOnRenderImageInstance (RenderTexture source, RenderTexture destination) {
												...
												if (fogRenderer.useSinglePassStereoRenderingMatrix && UnityEngine.VR.VRSettings.enabled) {
								...
								void GetTransparentDepth () {
												...
												if (_computeDepthScope == COMPUTE_DEPTH_SCOPE.OnlyTreeBillboards) {
																depthCam.RenderWithShader (depthShader, "RenderType");
												} else {
																depthCam.RenderWithShader (depthShader, null);
												}
								...
								void SetBlurTexture (RenderTexture source) {
												...
												RenderTexture temp1 = RenderTexture.GetTemporary (source.descriptor); // source.width, source.height, 0, source.format);
												Graphics.Blit (source, temp1, blurMat, 0);
												RenderTexture temp2 = RenderTexture.GetTemporary (source.descriptor); // source.width, source.height, 0, source.format);
			...
			_useSinglePassStereoRenderingMatrix = PlayerSettings.singlePassStereoRendering;
												...
												if (!_renderBeforeTransparent && _transparencyBlendMode == TRANSPARENT_MODE.Blend) {
																fogMat.SetFloat ("_BlendPower", _transparencyBlendPower);
								...
								void UpdateWindSpeedQuick () {
												...
												// fog speed
												float scale = 0.01f / _noiseScale;
												windSpeedAcum += Time.deltaTime * _windDirection * _speed / scale;
