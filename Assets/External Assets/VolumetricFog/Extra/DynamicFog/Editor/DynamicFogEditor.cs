	...
	public class DynamicFogEditor : Editor
	{
		...
		public override void OnInspectorGUI ()
		{
			...
			case (int)FOG_TYPE.DesktopFogPlusWithSkyHaze:
				EditorGUILayout.HelpBox ("BEST LOOK. 5 step raymarching based fog effect which does not require geometry. Uses a more complex algorithm to simulate 3D noise in world space. Also adds sky haze at the background.", MessageType.Info);
				break;
