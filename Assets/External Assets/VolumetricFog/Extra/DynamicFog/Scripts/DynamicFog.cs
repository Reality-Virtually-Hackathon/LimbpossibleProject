...
if (fogMatDesktopPlusOrthogonal != null) {
	...
	case FOG_TYPE.DesktopFogPlusOrthogonal:
				...
				break;
												...
												fogMat.SetFloat ("_FogSpeed", effectType == FOG_TYPE.DesktopFogPlusWithSkyHaze ? speed * 5f : speed);

												Vector4 noiseData = new Vector4 (noiseStrength, turbulence, currentCamera.farClipPlane * 15.0f / 1000f, noiseScale);
			...
			if (effectType == FOG_TYPE.MobileFogOrthogonal || effectType == FOG_TYPE.DesktopFogPlusOrthogonal) {
